...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies__turf_turf: string;
	...
	export const npm_package_devDependencies__auth_sveltekit: string;
	...
	export const npm_package_devDependencies_svelte_input_mask: string;
	...
	export const npm_package_devDependencies__googlemaps_google_maps_services_js: string;
	export const NVM_DIR: string;
	export const USER: string;
	export const npm_package_description: string;
	export const npm_package_devDependencies__auth_core: string;
	export const npm_package_devDependencies_postcss_csso: string;
	export const npm_package_scripts_check_watch: string;
	export const COMMAND_MODE: string;
	export const npm_package_devDependencies_postcss_preset_env: string;
	export const npm_package_devDependencies_filepond: string;
	export const npm_package_devDependencies__sveltejs_adapter_static: string;
	export const npm_package_devDependencies_svelte_persisted_store: string;
	export const SSH_AUTH_SOCK: string;
	export const npm_package_devDependencies_svelte_routing: string;
	...
	export const npm_package_devDependencies_svelte_scrolling: string;
	export const npm_package_devDependencies_svelte: string;
	export const npm_package_devDependencies_filepond_plugin_image_exif_orientation: string;
	export const npm_package_devDependencies__neodrag_svelte: string;
	...
	export const npm_package_devDependencies__jhubbardsf_svelte_sortablejs: string;
	...
	export const npm_package_devDependencies_filepond_plugin_image_preview: string;
	export const npm_config_bin_links: string;
	export const npm_package_engines_node: string;
	export const npm_package_devDependencies_svelte_range_slider_pips: string;
	...
	export const npm_package_devDependencies__mapbox_geojson_rewind: string;
	...
	export const npm_package_devDependencies_svelte_skeleton: string;
	export const npm_package_devDependencies_svelte_reactive_preprocessor: string;
	export const LOGNAME: string;
	export const YARN_WRAP_OUTPUT: string;
	export const npm_package_devDependencies_svelte_filepond: string;
	export const npm_package_devDependencies_d3_interpolate: string;
	...
	export const npm_package_devDependencies_svelte_select: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		AUTH_SECRET: string;
		NVM_INC: string;
		npm_package_devDependencies__turf_turf: string;
		...
		npm_package_devDependencies__auth_sveltekit: string;
		...
		npm_package_devDependencies_svelte_input_mask: string;
		...
		npm_package_devDependencies__googlemaps_google_maps_services_js: string;
		NVM_DIR: string;
		USER: string;
		npm_package_description: string;
		npm_package_devDependencies__auth_core: string;
		npm_package_devDependencies_postcss_csso: string;
		npm_package_scripts_check_watch: string;
		COMMAND_MODE: string;
		npm_package_devDependencies_postcss_preset_env: string;
		npm_package_devDependencies_filepond: string;
		npm_package_devDependencies__sveltejs_adapter_static: string;
		npm_package_devDependencies_svelte_persisted_store: string;
		SSH_AUTH_SOCK: string;
		npm_package_devDependencies_svelte_routing: string;
		...
		npm_execpath: string;
		npm_package_devDependencies_svelte_scrolling: string;
		npm_package_devDependencies_svelte: string;
		npm_package_devDependencies_filepond_plugin_image_exif_orientation: string;
		npm_package_devDependencies__neodrag_svelte: string;
		...
		npm_package_devDependencies__jhubbardsf_svelte_sortablejs: string;
		...
		npm_package_devDependencies_filepond_plugin_image_preview: string;
		npm_config_bin_links: string;
		npm_package_engines_node: string;
		npm_package_devDependencies_svelte_range_slider_pips: string;
		...
		npm_package_devDependencies__mapbox_geojson_rewind: string;
		SHLVL: string;
		HOME: string;
		...
		npm_package_devDependencies_svelte_skeleton: string;
		npm_package_devDependencies_svelte_reactive_preprocessor: string;
		LOGNAME: string;
		YARN_WRAP_OUTPUT: string;
		npm_package_devDependencies_svelte_filepond: string;
		npm_package_devDependencies_d3_interpolate: string;
		...
		npm_package_devDependencies_svelte_select: string;
