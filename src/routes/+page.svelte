...
<main class="w-full py-5 md:py-10 overflow-hidden" transition:slide>
	<div
	...
	>
		<div class="pointer-events-none absolute inset-x-0 top-0 flex justify-center">
			...
			>
				<div>
					<img alt="" width="2646" height="1301" />
				</div>
				<div
					style="filter:blur(2) overflow-hidden"
					class="overflow-hidden absolute inset-0 translate-x-[60px] [mask-image:linear-gradient(black_50%,transparent)] before:absolute before:inset-0 before:bg-gradient-to-r before:from-zinc-950 before:via-transparent before:to-zinc-950"
				>
					<img
						alt=""
						fetchpriority="high"
						...
						decoding="async"
						data-nimg="1"
						style="color:transparent; filter:blur(2)"
						srcset="/images/firstPage.png"
	...
	<div class="relative z-10 mx-auto max-w-md px-4 sm:max-w-lg">
		<div
			class="ax1 absolute inset-x-6 inset-y-0 -z-10 block   max-sm:hidden"
			style="opacity: 1; transform: none; overflow: hidden"
		/>
		<div class="isolate" style="opacity: 1; transform: none;">
			<div class="">
				<div
					class="mx-auto w-full max-w-sm rounded-2xl"
					style="will-change: transform; transition: all 500ms cubic-bezier(0.03, 0.98, 0.52, 0.99) 0s; transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);"
				>
					<div  transition:fade
						class="blackbox rounded-2xl bg-[rgba(9,9,11,0.97)] bg-[image:radial-gradient(221.02%_101.62%_at_50%_0%,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0)_78.73%)] shadow-[0_2px_20px_rgba(0,0,0,0.5),0_20px_28px_rgba(0,0,0,0.4),inset_0_0.5px_0_rgba(153,253,255,0.1),inset_0_0_0_1px_rgba(255,255,255,0.06)]"
						style="opacity: 1; transform: none;"
					>
					{#if $page.data.session || auth==false}
                    <a href="/protected/data" alt="otwórz">
                    
                        <div class="ax2 relative flex flex-col items-center overflow-hidden border-b border-dashed border-white/10 pb-14">
							<div class="frontcoverA">
								<img src="/images/firstPage.png" alt="|" class="frontImage" />
							</div>

							<div class="absolute inset-0 flex items-start justify-center">
								<div class="h-full w-full [mask-image:linear-gradient(black_75%,transparent)]">
									<svg
										viewBox="0 0 384 449"
										fill="none"
                    ...
                    {/if}
						<div
							...
							class="boxunder flex items-center justify-between overflow-hidden p-4 font-mono text-[.6875rem]/4 font-bold text-zinc-500 md:p-6"
						>
									...
									<div>
										<button on:click={() => signOut()} class="button">
											...
											>
												...
												<polyline
													class="signOut"
													points="157.2 64.91 40.04 64.91 67.56 36.56 37.3 64.91 66.56 94.56"
												/>
												<path
													class="signOut"
													d="m118.97,97.69c-17.35,29.02-55.52,38.63-84.54,21.27C5.4,101.61-4.21,63.45,13.15,34.42S68.67-4.21,97.69,13.15c8.04,4.81,14.87,11.38,19.99,19.22"
												/>
											</svg>
										</button>
									</div>
							...
							{#if $page.data.session}
								<div class="flex justify-right">
									<div class="relative" aria-hidden="true" transition:fade>
										<svg style="transform: translateX(50%) translateY(0px) translateZ(0px)"
											width="135"
											height="43"
											viewBox="0 0 135 43"
											fill="none"
										...
										<div
											style="transform: translateX(-20%) translateY(-47.6417px) translateZ(0px); opacity: 1;"
											class="absolute -bottom-2 left-1/2 z-10 h-px w-[110%] bg-gradient-to-r from-[#38BDF8]/10 via-[#38BDF8]/50 to-[#38BDF8]/10"
										>
											<div
												class="absolute inset-0 bg-gradient-to-r from-[#38BDF8]/20 via-[#38BDF8]/50 to-[#38BDF8]/20 blur-[1px]"
											/>
											<div
												class="absolute -inset-x-4 top-0 flex h-[100px] justify-center overflow-hidden"
											>
												<div
													class="absolute h-32 w-32 -translate-y-1/2 rounded-full bg-sky-300/10 blur-xl"
												/>
												<div
													class="absolute h-20 w-20 -translate-y-3/4 rounded-full bg-sky-300/10 blur-xl"
												/>
												<div
													class="absolute h-16 w-16 -translate-y-1/2 rounded-full bg-sky-300/20 blur-xl"
												/>
											</div>
										</div>
									</div>
...
#signOut{
	...
	.blackbox {
		background-color: rgba(179, 180, 182, 0.6) !important;
	}
